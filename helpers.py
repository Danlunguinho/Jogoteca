...
class FormularioJogo(FlaskForm):
    nome = StringField('Nome do Jogo', [validators.data_required()], 
                       validators.Length(min=1, max=50))
    categoria = StringField('Categoria do Jogo', [validators.data_required()], 
                            validators.Length(min=1, max=40))
    console = StringField('Console', [validators.data_required()], 
